...
public class PhrasesQuizResultCorrectWordsSummaryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.f_phrases_quiz_result_correct_words_summary, container, false);
        initColors();
    ...
    private void loadViewsFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_phrases_quiz_result_correct_words_summary);
        title = (TextView) rootView.findViewById(R.id.f_phrases_quiz_result_correct_words_summary_title);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_phrases_quiz_result_correct_words_summary_table);
        back = (Button) rootView.findViewById(R.id.f_phrases_quiz_result_correct_words_summary_back);
    }
    ...
    private void addWords() {
        boolean color = true;
        for(PhraseEntity word : PhrasesQuizData.getQuizData().correctAnswers) {

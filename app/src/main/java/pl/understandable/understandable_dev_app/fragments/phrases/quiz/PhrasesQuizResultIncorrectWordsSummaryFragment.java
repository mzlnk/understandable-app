package pl.understandable.understandable_dev_app.fragments.phrases.quiz;
...
import pl.understandable.understandable_dev_app.data.entities_data.phrases.PhrasesQuizData;
...
public class PhrasesQuizResultIncorrectWordsSummaryFragment extends Fragment {
    ...
    public PhrasesQuizResultIncorrectWordsSummaryFragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.f_phrases_quiz_result_incorrect_words_summary, container, false);
        initColors();
    ...
    private void loadViewsFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_phrases_quiz_result_incorrect_words_summary);
        title = (TextView) rootView.findViewById(R.id.f_phrases_quiz_result_incorrect_words_summary_title);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_phrases_quiz_result_incorrect_words_summary_table);
        back = (Button) rootView.findViewById(R.id.f_phrases_quiz_result_incorrect_words_summary_back);
    }
    ...
    private void addWords() {
        boolean color = true;
        for(PhraseEntity word : PhrasesQuizData.getQuizData().incorrectAnswers) {

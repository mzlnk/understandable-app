package pl.understandable.understandable_dev_app.fragments.custom_words.quiz;
...
public class CustomWordsQuizResultIncorrectWordsSummaryFragment extends Fragment {
    ...
    public CustomWordsQuizResultIncorrectWordsSummaryFragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.f_custom_words_quiz_result_incorrect_words_summary, container, false);
        initColors();
    ...
    private void loadViewsFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_custom_words_quiz_result_incorrect_words_summary);
        title = (TextView) rootView.findViewById(R.id.f_custom_words_quiz_result_incorrect_words_summary_title);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_custom_words_quiz_result_incorrect_words_summary_table);
        back = (Button) rootView.findViewById(R.id.f_custom_words_quiz_result_incorrect_words_summary_back);
    }
    ...
    private void addWords() {
        boolean color = true;
        for(CustomWordEntity word : CustomWordsQuizData.getQuizData().incorrectAnswers) {

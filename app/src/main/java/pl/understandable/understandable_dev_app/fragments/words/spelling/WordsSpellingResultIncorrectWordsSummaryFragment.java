package pl.understandable.understandable_dev_app.fragments.words.spelling;
...
public class WordsSpellingResultIncorrectWordsSummaryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.f_words_spelling_result_incorrect_words_summary, container, false);
        initColors();
    ...
    private void loadViewsFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_words_spelling_result_incorrect_words_summary);
        title = (TextView) rootView.findViewById(R.id.f_words_spelling_result_incorrect_words_summary_title);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_words_spelling_result_incorrect_words_summary_table);
        back = (Button) rootView.findViewById(R.id.f_words_spelling_result_incorrect_words_summary_back);
    }
    ...
    private void addWords() {
        boolean color = true;
        for(WordEntity word : WordsSpellingData.getSpellingData().incorrectAnswers) {

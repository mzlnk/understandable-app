package pl.understandable.understandable_dev_app.fragments.phrases.repetition;
...
import pl.understandable.understandable_dev_app.data.entities_data.phrases.PhrasesRepetitionData;
...
public class PhrasesRepetitionResultWordsToRepeatFragment extends Fragment {
    ...
    public PhrasesRepetitionResultWordsToRepeatFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView =  inflater.inflate(R.layout.f_phrases_repetition_result_words_to_repeat, container, false);
        initColors();
    ...
    private void loadViewFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_phrases_repetition_result_words_to_repeat);
        title = (TextView) rootView.findViewById(R.id.f_phrases_repetition_result_words_to_repeat_title);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_phrases_repetition_result_words_to_repeat_table);
        back = (Button) rootView.findViewById(R.id.f_phrases_repetition_result_words_to_repeat_back);
    }
    ...
    private void addWords() {
        ...
        for(PhraseEntity word : repetitionData.wordsToRepeat) {

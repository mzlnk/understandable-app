...
public class CustomWordsPronunciationButton extends BaseButton {

    private CurrentWordData<CustomWordEntity> currentWordData;

    private TextToSpeech tts;

    public CustomWordsPronunciationButton(Context context, CurrentWordData<CustomWordEntity> currentWordData) {

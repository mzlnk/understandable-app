...
public class GrammarFillGapResultCorrectExamplesSummaryFragment extends Fragment {
    ...
    public GrammarFillGapResultCorrectExamplesSummaryFragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.f_grammar_fill_gap_result_correct_examples_summary, container, false);
        initColors();
    ...
    private void loadViewsFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_grammar_fill_gap_result_correct_examples_summary);
        title = (TextView) rootView.findViewById(R.id.f_grammar_fill_gap_result_correct_examples_summary_title);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_grammar_fill_gap_result_correct_examples_summary_table);
        back = (Button) rootView.findViewById(R.id.f_grammar_fill_gap_result_correct_examples_summary_back);
    }
    ...
    private void addWords() {
        ...
        for(GrammarFillGapEntity entity : GrammarFillGapData.getFillGapData().correctAnswers) {

package pl.understandable.understandable_app.fragments.custom_words.list;
...
public class CustomWordsListFragment extends Fragment {
    ...
    public CustomWordsListFragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.f_custom_words_list, container, false);
        initColors();
    ...
    private void loadViewsFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_custom_words_list);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_custom_words_list_table);
        scrollViewArea = (ScrollView) rootView.findViewById(R.id.f_custom_words_list_scroll_view_area);
        title = (TextView) rootView.findViewById(R.id.f_custom_words_list_title);
        previous = (Button) rootView.findViewById(R.id.f_custom_words_list_button_previous);
        next = (Button) rootView.findViewById(R.id.f_custom_words_list_button_next);
    }
    ...
    private void addListeners() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(start + ELEMENTS_PER_PAGE >= CustomWordsListData.getListData().getEntities().size()) {

...
public class CustomWordsSpellingExampleFragment extends Fragment {
    ...
    private void loadViewsFromXml(View rootView) {
        word0 = (TextView) rootView.findViewById(R.id.f_custom_words_spelling_example_word_1);
        word1 = (TextView) rootView.findViewById(R.id.f_custom_words_spelling_example_word_2);

...
public class GrammarQuizResultIncorrectExamplesSummaryFragment extends Fragment {
    ...
    public GrammarQuizResultIncorrectExamplesSummaryFragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.f_grammar_quiz_result_incorrect_examples_summary, container, false);
        initColors();
    ...
    private void loadViewsFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_grammar_quiz_result_incorrect_examples_summary);
        title = (TextView) rootView.findViewById(R.id.f_grammar_quiz_result_incorrect_examples_summary_title);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_grammar_quiz_result_incorrect_examples_summary_table);
        back = (Button) rootView.findViewById(R.id.f_grammar_quiz_result_incorrect_examples_summary_back);
    }
    ...
    private void addWords() {
        ...
        for(GrammarQuizEntity entity : GrammarQuizData.getQuizData().incorrectAnswers) {
    ...
    private void addListeners() {
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentManager.beginTransaction().replace(R.id.layout_for_fragments, new GrammarQuizResultFragment(), redirectTo(F_GRAMMAR_SET_PREVIEW, id, name)).commit();
            }
        });
    }

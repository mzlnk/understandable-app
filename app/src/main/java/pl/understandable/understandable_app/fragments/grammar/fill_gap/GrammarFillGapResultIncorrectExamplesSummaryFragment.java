...
public class GrammarFillGapResultIncorrectExamplesSummaryFragment extends Fragment {
    ...
    public GrammarFillGapResultIncorrectExamplesSummaryFragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.f_grammar_fill_gap_result_incorrect_examples_summary, container, false);
        initColors();
    ...
    private void loadViewsFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_grammar_fill_gap_result_incorrect_examples_summary);
        title = (TextView) rootView.findViewById(R.id.f_grammar_fill_gap_result_incorrect_examples_summary_title);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_grammar_fill_gap_result_incorrect_examples_summary_table);
        back = (Button) rootView.findViewById(R.id.f_grammar_fill_gap_result_incorrect_examples_summary_back);
    }
    ...
    private void addWords() {
        ...
        for(GrammarFillGapEntity entity : GrammarFillGapData.getFillGapData().incorrectAnswers) {
            TableRow row = new TableRow(getContext());
            TextView t = new TextView(getContext());;
            prepareCell(t, entity.getSentence(), entity.getGap(), false);
    ...
    private void addListeners() {
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String id = GrammarFillGapData.getFillGapData().getParams().id;
                String name = GrammarFillGapData.getFillGapData().getParams().name;
                fragmentManager.beginTransaction().replace(R.id.layout_for_fragments, new GrammarFillGapResultFragment(), redirectTo(F_GRAMMAR_SET_PREVIEW, id, name)).commit();
            }
        });
    }

...
public class WordsListFragment extends Fragment {
    ...
    private void loadViewsFromXml(View rootView) {
        ...
        scrollViewArea = (ScrollView) rootView.findViewById(R.id.f_words_list_scroll_view_area);
        title = (TextView) rootView.findViewById(R.id.f_words_list_title);
        previous = (Button) rootView.findViewById(R.id.f_words_list_button_previous);
        next = (Button) rootView.findViewById(R.id.f_words_list_button_next);
    }
    ...
    private void addListeners() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(start + ELEMENTS_PER_PAGE >= WordsListData.getListData().getEntities().size()) {

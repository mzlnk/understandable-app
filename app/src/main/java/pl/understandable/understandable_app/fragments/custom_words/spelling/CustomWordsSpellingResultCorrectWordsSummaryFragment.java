...
public class CustomWordsSpellingResultCorrectWordsSummaryFragment extends Fragment {
    ...
    public CustomWordsSpellingResultCorrectWordsSummaryFragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.f_custom_words_spelling_result_correct_words_summary, container, false);
        initColors();
    ...
    private void loadViewsFromXml(View rootView) {
        mainLayout = (RelativeLayout) rootView.findViewById(R.id.f_custom_words_spelling_result_correct_words_summary);
        title = (TextView) rootView.findViewById(R.id.f_custom_words_spelling_result_correct_words_summary_title);
        wordsTable = (TableLayout) rootView.findViewById(R.id.f_custom_words_spelling_result_correct_words_summary_table);
        back = (Button) rootView.findViewById(R.id.f_custom_words_spelling_result_correct_words_summary_back);
    }
    ...
    private void addWords() {
        boolean color = true;
        for(CustomWordEntity word : CustomWordsSpellingData.getSpellingData().correctAnswers) {
